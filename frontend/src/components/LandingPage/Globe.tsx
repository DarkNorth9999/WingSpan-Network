...
// Import React lazy for dynamic imports
const World = React.lazy(() => import("../ui/Globe/Globe").then((m) => ({ default: m.World })));

export default function GlobeDemo() {
  // Your globeConfig and colors setup remains the same
    const globeConfig = {
      pointSize: 4,
      globeColor: "#062056",
      showAtmosphere: true,
